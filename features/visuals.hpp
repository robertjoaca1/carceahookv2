...
public:
	vgui::HFont TahomaBold12;
	vgui::HFont Visitor9;
	vgui::HFont Tahoma12;
	vgui::HFont SmallFonts8;
	void CreateFonts();
...
public:
	...
	void Weapon();
	void Health();
	void Skeleton(bool Backtrack);
	void BacktrackLine();
	void ColorModulateWalls();
	void ColorModulateSky();
	void AlphaModulateProps();
	void LocalPlayerFlags();
};